...
<html>
    ...
    <body>
        ...
        %>
        <div class="container">
            <h1 class=" text-center mt-5 ">Delete</h1>
            <h2 class=" text-center mt-5 ">Are you sure you want to delete this car?</h2>
                        ...
                        <div class="card-body bg-light">
                            ...
                            <div class = "container">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="DeleteServlet?CarID=<%=car.getCarID()%>" method="post">
                                        <input class="btn btn-success btn-send  pt-2 btn-block" type="submit" value="Delete" name ="btnLogin" />  
