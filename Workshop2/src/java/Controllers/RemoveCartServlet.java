...
public class RemoveCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            initQuantity = Integer.parseInt(request.getParameter("initQuantity"));
            if(itemId != null) {
                ...
                mobileDAO.updateMobileQuantity(itemId, initQuantity);
                
                message = "The mobile "+itemId+" has been removed successfully";
                request.setAttribute("msg", message);
                url = "HomeUserController?action=View Cart";
            }
        }catch(Exception e) {
