...
public class AccountDAO {
    ...
    public boolean updateAccount(AccountDTO account) {
        ...
        public boolean updateCusAccount(AccountDTO account) {
        String sql = "UPDATE Account SET CustomerID = ? WHERE accountId = ?";
        try {
            Connection conn = DBUtils.getConnection();
            PreparedStatement statement = conn.prepareStatement(sql);

            statement.setInt(1, account.getCustomerId().intValue());
