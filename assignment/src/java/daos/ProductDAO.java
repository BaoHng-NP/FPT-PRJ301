...
public class ProductDAO {
    ...
    public boolean updateProduct(ProductDTO product) {
        ...
        String sql = "UPDATE Products SET quantityPerUnit = ? WHERE productId = ?";
        try {
            Connection connection = DBUtils.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public List<ProductDTO> getProductByProductName(String productName) {
        ...
        public List<ProductDTO> getProductByCategories(String categoryId) {
    ...
    public List<ProductDTO> searchProductByIdOrNameOrUnitPrice(String keyword) {
        ...
        List<ProductDTO> lists=dao.getProductByCategories("3");
        for(ProductDTO c:lists){
