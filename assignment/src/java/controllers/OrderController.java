...
public class OrderController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if((product.getQuantityPerUnit()-Integer.parseInt(quantity))<0){
        request.setAttribute("msg","not enough quantity");
        ...
        dao.updateCusAccount(loggedInAccount);
        
        dao.updateAccount(loggedInAccount);
        ...
        productDAO.updateProductQuantity(Long.parseLong(productId),product.getQuantityPerUnit()-Integer.parseInt(quantity));
