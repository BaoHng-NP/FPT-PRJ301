...
public class UpdateCustomer extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.sendRedirect("Update-Customer.jsp");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        long accID=loggedInAccount.getCustomerId();
        CustomerDAO cDAO=new CustomerDAO();
        //CustomerDTO cus=cDAO.getCustomerById(accID);
        
        String name=request.getParameter("contactName");
        String add=request.getParameter("address");
        String phone=request.getParameter("phone");
        //String id=cus.getCustomerId();
        cDAO.updateCustomer(accID, name, add, phone);
        request.setAttribute("msg", "update Customer successfully!");
